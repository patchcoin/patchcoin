...
CacheSizes CalculateCacheSizes(const ArgsManager& args, size_t n_indexes)
{
    ...
    // patchcoin todo simulate full cache size // eg. max 200k entries
    sizes.claim_index = std::min(nTotalCache / 8, nMaxClaimIndexCache << 20);
    nTotalCache -= sizes.claim_index;
