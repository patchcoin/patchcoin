...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Patchcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and patchcoin: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Patchcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify Message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Patchcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a patchcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Patchcoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Patchcoin network.", "", count);
    } else {
        //: A substring of the tooltip.
