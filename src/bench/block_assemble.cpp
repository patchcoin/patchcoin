...
static void AssembleBlock(benchmark::Bench& bench)
{
    ...
    // patchcoin todo
    txs.reserve(NUM_BLOCKS - ::Params().GetConsensus().GetnCoinbaseMaturity(::Params().GetConsensus().nCoinbaseMaturity) + 1);
    for (size_t b{0}; b < NUM_BLOCKS; ++b) {
        ...
        // patchcoin todo
        if (NUM_BLOCKS - b >= ::Params().GetConsensus().GetnCoinbaseMaturity(::Params().GetConsensus().nCoinbaseMaturity))
