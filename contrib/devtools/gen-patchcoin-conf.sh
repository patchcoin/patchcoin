...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/patchcoin.conf}
...
then
  ...
  echo -e "To safely generate a patchcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example patchcoin.conf file in share/examples/'
...
##
## patchcoin.conf configuration file.
## Generated by contrib/devtools/gen-patchcoin-conf.sh.
##
